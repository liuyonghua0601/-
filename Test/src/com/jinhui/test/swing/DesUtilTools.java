 ...
 * author:liuyonghua
 */
public class DesUtilTools extends JFrame implements ActionListener{

	GridBagLayout g=new GridBagLayout();
	GridBagConstraints c=new GridBagConstraints();
	DesUtilTools(String str){
		super(str);
		setSize(800,500);
...
//使用的网格包布局;希望楼主能看懂;
	...
	public void addComponent(){
		//个人信息登记
		noteInformation=new JLabel("DES+BASE64加解密",JLabel.CENTER);
	...
	public static void main(String args[]){
		new DesUtilTools("DES+BASE64加解密");
	}
			...
			if("加密>>".equals(name)){
				...
				if(StringUtils.isNotBlank(t)){
					...
					DESUtils desUtils = new DESUtils();
			      	String resultstr = desUtils.strEnc(data, key, "", "");
			      	resultstr = Base64.encode(resultstr.getBytes());
				...
				if(StringUtils.isNotBlank(d)){
					d = d.trim();
					String des = new String(Base64.decode(d));
					String resultstr = DESUtils.strDec(des, key,null,null);
